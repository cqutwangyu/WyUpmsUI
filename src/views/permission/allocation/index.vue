      ...
      <el-container>
        ...
        <el-container>
          <el-card style="width: 100%;">
            ...
            <el-tree :data="data" default-expand-all="true" :props="{label:'menuName',children:'children'}" @node-click="handleMenuNodeClick">
  ...
  export default {
    ...
    methods: {
      ...
      updatePower(data) {
        ...
        this.$store.dispatch('allocation/update', this.menuForm).then(response => {
          this.resetMenuForm()
          this.listMenuTreeNode()
        })
      },
